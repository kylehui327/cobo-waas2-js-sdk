...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionRequestSOLFee();
  });
  ...
  describe('TransactionRequestSOLFee', function() {
    it('should create an instance of TransactionRequestSOLFee', function() {
      // uncomment below and update the code to test TransactionRequestSOLFee
      //var instance = new CoboWaas2.TransactionRequestSOLFee();
      //expect(instance).to.be.a(CoboWaas2.TransactionRequestSOLFee);
    });
