...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationUnpauseEstimateFeeParams();
  });
  ...
  describe('TokenizationUnpauseEstimateFeeParams', function() {
    it('should create an instance of TokenizationUnpauseEstimateFeeParams', function() {
      // uncomment below and update the code to test TokenizationUnpauseEstimateFeeParams
      //var instance = new CoboWaas2.TokenizationUnpauseEstimateFeeParams();
      //expect(instance).to.be.a(CoboWaas2.TokenizationUnpauseEstimateFeeParams);
    });
