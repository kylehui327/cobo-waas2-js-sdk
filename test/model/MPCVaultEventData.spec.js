...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.MPCVaultEventData();
  });
  ...
  describe('MPCVaultEventData', function() {
    it('should create an instance of MPCVaultEventData', function() {
      // uncomment below and update the code to test MPCVaultEventData
      //var instance = new CoboWaas2.MPCVaultEventData();
      //expect(instance).to.be.a(CoboWaas2.MPCVaultEventData);
    });
