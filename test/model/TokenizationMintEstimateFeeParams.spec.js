...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationMintEstimateFeeParams();
  });
  ...
  describe('TokenizationMintEstimateFeeParams', function() {
    it('should create an instance of TokenizationMintEstimateFeeParams', function() {
      // uncomment below and update the code to test TokenizationMintEstimateFeeParams
      //var instance = new CoboWaas2.TokenizationMintEstimateFeeParams();
      //expect(instance).to.be.a(CoboWaas2.TokenizationMintEstimateFeeParams);
    });
