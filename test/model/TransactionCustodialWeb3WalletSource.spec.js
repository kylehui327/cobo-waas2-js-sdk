...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionCustodialWeb3WalletSource();
  });
  ...
  describe('TransactionCustodialWeb3WalletSource', function() {
    it('should create an instance of TransactionCustodialWeb3WalletSource', function() {
      // uncomment below and update the code to test TransactionCustodialWeb3WalletSource
      //var instance = new CoboWaas2.TransactionCustodialWeb3WalletSource();
      //expect(instance).to.be.a(CoboWaas2.TransactionCustodialWeb3WalletSource);
    });
