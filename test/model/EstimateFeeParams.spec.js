...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimateFeeParams();
  });
  ...
  describe('EstimateFeeParams', function() {
    it('should create an instance of EstimateFeeParams', function() {
      // uncomment below and update the code to test EstimateFeeParams
      //var instance = new CoboWaas2.EstimateFeeParams();
      //expect(instance).to.be.a(CoboWaas2.EstimateFeeParams);
    });
