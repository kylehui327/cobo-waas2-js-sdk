...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.WebhookEndpoint();
  });
  ...
  describe('WebhookEndpoint', function() {
    it('should create an instance of WebhookEndpoint', function() {
      // uncomment below and update the code to test WebhookEndpoint
      //var instance = new CoboWaas2.WebhookEndpoint();
      //expect(instance).to.be.a(CoboWaas2.WebhookEndpoint);
    });
