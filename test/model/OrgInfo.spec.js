...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.OrgInfo();
  });
  ...
  describe('OrgInfo', function() {
    it('should create an instance of OrgInfo', function() {
      // uncomment below and update the code to test OrgInfo
      //var instance = new CoboWaas2.OrgInfo();
      //expect(instance).to.be.a(CoboWaas2.OrgInfo);
    });
