...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EthStakingActivityDetailExtra();
  });
  ...
  describe('EthStakingActivityDetailExtra', function() {
    it('should create an instance of EthStakingActivityDetailExtra', function() {
      // uncomment below and update the code to test EthStakingActivityDetailExtra
      //var instance = new CoboWaas2.EthStakingActivityDetailExtra();
      //expect(instance).to.be.a(CoboWaas2.EthStakingActivityDetailExtra);
    });
