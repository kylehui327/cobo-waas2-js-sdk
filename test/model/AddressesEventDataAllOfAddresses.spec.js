...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.AddressesEventDataAllOfAddresses();
  });
  ...
  describe('AddressesEventDataAllOfAddresses', function() {
    it('should create an instance of AddressesEventDataAllOfAddresses', function() {
      // uncomment below and update the code to test AddressesEventDataAllOfAddresses
      //var instance = new CoboWaas2.AddressesEventDataAllOfAddresses();
      //expect(instance).to.be.a(CoboWaas2.AddressesEventDataAllOfAddresses);
    });
