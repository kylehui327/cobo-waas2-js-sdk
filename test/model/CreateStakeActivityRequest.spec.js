...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateStakeActivityRequest();
  });
  ...
  describe('CreateStakeActivityRequest', function() {
    it('should create an instance of CreateStakeActivityRequest', function() {
      ...
      //var instance = new CoboWaas2.CreateStakeActivityRequest();
      //expect(instance).to.be.a(CoboWaas2.CreateStakeActivityRequest);
    });
