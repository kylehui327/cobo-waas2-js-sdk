...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimatedFILFeeSlow();
  });
  ...
  describe('EstimatedFILFeeSlow', function() {
    it('should create an instance of EstimatedFILFeeSlow', function() {
      // uncomment below and update the code to test EstimatedFILFeeSlow
      //var instance = new CoboWaas2.EstimatedFILFeeSlow();
      //expect(instance).to.be.a(CoboWaas2.EstimatedFILFeeSlow);
    });
