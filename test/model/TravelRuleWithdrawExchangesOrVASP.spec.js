...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TravelRuleWithdrawExchangesOrVASP();
  });
  ...
  describe('TravelRuleWithdrawExchangesOrVASP', function() {
    it('should create an instance of TravelRuleWithdrawExchangesOrVASP', function() {
      // uncomment below and update the code to test TravelRuleWithdrawExchangesOrVASP
      //var instance = new CoboWaas2.TravelRuleWithdrawExchangesOrVASP();
      //expect(instance).to.be.a(CoboWaas2.TravelRuleWithdrawExchangesOrVASP);
    });
