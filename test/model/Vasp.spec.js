...
(function(root, factory) {
  ...
  describe('Vasp', function() {
    it('should create an instance of Vasp', function() {
      // uncomment below and update the code to test Vasp
      //var instance = new CoboWaas2.Vasp();
      //expect(instance).to.be.a(CoboWaas2.Vasp);
    });
