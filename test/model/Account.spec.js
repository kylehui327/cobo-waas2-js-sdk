...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new CoboWaas2.Account();
      //expect(instance).to.be.a(CoboWaas2.Account);
    });
    ...
    it('should have the property merchant_balance (base name: "merchant_balance")', function() {
      // uncomment below and update the code to test the property merchant_balance
      //var instance = new CoboWaas2.Account();
      //expect(instance).to.be();
    });

    it('should have the property psp_balance (base name: "psp_balance")', function() {
      // uncomment below and update the code to test the property psp_balance
      //var instance = new CoboWaas2.Account();
      //expect(instance).to.be();
    });
