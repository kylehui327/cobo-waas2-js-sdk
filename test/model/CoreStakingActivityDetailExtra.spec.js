...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CoreStakingActivityDetailExtra();
  });
  ...
  describe('CoreStakingActivityDetailExtra', function() {
    it('should create an instance of CoreStakingActivityDetailExtra', function() {
      // uncomment below and update the code to test CoreStakingActivityDetailExtra
      //var instance = new CoboWaas2.CoreStakingActivityDetailExtra();
      //expect(instance).to.be.a(CoboWaas2.CoreStakingActivityDetailExtra);
    });
