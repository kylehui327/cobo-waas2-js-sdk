...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreatedWalletInfo();
  });
  ...
  describe('CreatedWalletInfo', function() {
    it('should create an instance of CreatedWalletInfo', function() {
      // uncomment below and update the code to test CreatedWalletInfo
      //var instance = new CoboWaas2.CreatedWalletInfo();
      //expect(instance).to.be.a(CoboWaas2.CreatedWalletInfo);
    });
