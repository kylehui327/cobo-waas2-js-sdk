...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.SwapTokenPair();
  });
  ...
  describe('SwapTokenPair', function() {
    it('should create an instance of SwapTokenPair', function() {
      // uncomment below and update the code to test SwapTokenPair
      //var instance = new CoboWaas2.SwapTokenPair();
      //expect(instance).to.be.a(CoboWaas2.SwapTokenPair);
    });
