...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimateContractCallFeeParams();
  });
  ...
  describe('EstimateContractCallFeeParams', function() {
    it('should create an instance of EstimateContractCallFeeParams', function() {
      // uncomment below and update the code to test EstimateContractCallFeeParams
      //var instance = new CoboWaas2.EstimateContractCallFeeParams();
      //expect(instance).to.be.a(CoboWaas2.EstimateContractCallFeeParams);
    });
