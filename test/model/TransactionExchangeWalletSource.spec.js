...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionExchangeWalletSource();
  });
  ...
  describe('TransactionExchangeWalletSource', function() {
    it('should create an instance of TransactionExchangeWalletSource', function() {
      ...
      //var instance = new CoboWaas2.TransactionExchangeWalletSource();
      //expect(instance).to.be.a(CoboWaas2.TransactionExchangeWalletSource);
    });
