...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.ExchangeTransferDestination();
  });
  ...
  describe('ExchangeTransferDestination', function() {
    it('should create an instance of ExchangeTransferDestination', function() {
      ...
      //var instance = new CoboWaas2.ExchangeTransferDestination();
      //expect(instance).to.be.a(CoboWaas2.ExchangeTransferDestination);
    });
