...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimatedFixedFee();
  });
  ...
  describe('EstimatedFixedFee', function() {
    it('should create an instance of EstimatedFixedFee', function() {
      // uncomment below and update the code to test EstimatedFixedFee
      //var instance = new CoboWaas2.EstimatedFixedFee();
      //expect(instance).to.be.a(CoboWaas2.EstimatedFixedFee);
    });
