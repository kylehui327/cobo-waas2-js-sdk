...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.SwapActivityDetail();
  });
  ...
  describe('SwapActivityDetail', function() {
    it('should create an instance of SwapActivityDetail', function() {
      // uncomment below and update the code to test SwapActivityDetail
      //var instance = new CoboWaas2.SwapActivityDetail();
      //expect(instance).to.be.a(CoboWaas2.SwapActivityDetail);
    });
