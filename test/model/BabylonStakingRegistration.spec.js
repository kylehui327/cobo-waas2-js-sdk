...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.BabylonStakingRegistration();
  });
  ...
  describe('BabylonStakingRegistration', function() {
    it('should create an instance of BabylonStakingRegistration', function() {
      // uncomment below and update the code to test BabylonStakingRegistration
      //var instance = new CoboWaas2.BabylonStakingRegistration();
      //expect(instance).to.be.a(CoboWaas2.BabylonStakingRegistration);
    });
