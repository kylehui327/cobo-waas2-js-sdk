...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateCustodialWalletParams();
  });
  ...
  describe('CreateCustodialWalletParams', function() {
    it('should create an instance of CreateCustodialWalletParams', function() {
      // uncomment below and update the code to test CreateCustodialWalletParams
      //var instance = new CoboWaas2.CreateCustodialWalletParams();
      //expect(instance).to.be.a(CoboWaas2.CreateCustodialWalletParams);
    });
