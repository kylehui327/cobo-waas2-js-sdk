...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationIssueEstimateFeeParams();
  });
  ...
  describe('TokenizationIssueEstimateFeeParams', function() {
    it('should create an instance of TokenizationIssueEstimateFeeParams', function() {
      // uncomment below and update the code to test TokenizationIssueEstimateFeeParams
      //var instance = new CoboWaas2.TokenizationIssueEstimateFeeParams();
      //expect(instance).to.be.a(CoboWaas2.TokenizationIssueEstimateFeeParams);
    });
