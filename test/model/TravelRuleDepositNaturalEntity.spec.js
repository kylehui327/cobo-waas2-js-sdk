...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TravelRuleDepositNaturalEntity();
  });
  ...
  describe('TravelRuleDepositNaturalEntity', function() {
    it('should create an instance of TravelRuleDepositNaturalEntity', function() {
      // uncomment below and update the code to test TravelRuleDepositNaturalEntity
      //var instance = new CoboWaas2.TravelRuleDepositNaturalEntity();
      //expect(instance).to.be.a(CoboWaas2.TravelRuleDepositNaturalEntity);
    });
