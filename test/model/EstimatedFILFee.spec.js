...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimatedFILFee();
  });
  ...
  describe('EstimatedFILFee', function() {
    it('should create an instance of EstimatedFILFee', function() {
      // uncomment below and update the code to test EstimatedFILFee
      //var instance = new CoboWaas2.EstimatedFILFee();
      //expect(instance).to.be.a(CoboWaas2.EstimatedFILFee);
    });
