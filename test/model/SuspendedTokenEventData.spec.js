...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.SuspendedTokenEventData();
  });
  ...
  describe('SuspendedTokenEventData', function() {
    it('should create an instance of SuspendedTokenEventData', function() {
      // uncomment below and update the code to test SuspendedTokenEventData
      //var instance = new CoboWaas2.SuspendedTokenEventData();
      //expect(instance).to.be.a(CoboWaas2.SuspendedTokenEventData);
    });
