...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateWalletParams();
  });
  ...
  describe('CreateWalletParams', function() {
    it('should create an instance of CreateWalletParams', function() {
      // uncomment below and update the code to test CreateWalletParams
      //var instance = new CoboWaas2.CreateWalletParams();
      //expect(instance).to.be.a(CoboWaas2.CreateWalletParams);
    });
