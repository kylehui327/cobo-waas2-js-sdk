...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.BalanceUpdateInfoEventData();
  });
  ...
  describe('BalanceUpdateInfoEventData', function() {
    it('should create an instance of BalanceUpdateInfoEventData', function() {
      // uncomment below and update the code to test BalanceUpdateInfoEventData
      //var instance = new CoboWaas2.BalanceUpdateInfoEventData();
      //expect(instance).to.be.a(CoboWaas2.BalanceUpdateInfoEventData);
    });
