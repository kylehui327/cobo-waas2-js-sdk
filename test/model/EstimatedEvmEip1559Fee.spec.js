...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimatedEvmEip1559Fee();
  });
  ...
  describe('EstimatedEvmEip1559Fee', function() {
    it('should create an instance of EstimatedEvmEip1559Fee', function() {
      // uncomment below and update the code to test EstimatedEvmEip1559Fee
      //var instance = new CoboWaas2.EstimatedEvmEip1559Fee();
      //expect(instance).to.be.a(CoboWaas2.EstimatedEvmEip1559Fee);
    });
