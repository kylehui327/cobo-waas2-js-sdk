...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionRequestFixedFee();
  });
  ...
  describe('TransactionRequestFixedFee', function() {
    it('should create an instance of TransactionRequestFixedFee', function() {
      // uncomment below and update the code to test TransactionRequestFixedFee
      //var instance = new CoboWaas2.TransactionRequestFixedFee();
      //expect(instance).to.be.a(CoboWaas2.TransactionRequestFixedFee);
    });
