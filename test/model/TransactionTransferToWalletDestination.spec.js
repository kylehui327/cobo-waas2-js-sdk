...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionTransferToWalletDestination();
  });
  ...
  describe('TransactionTransferToWalletDestination', function() {
    it('should create an instance of TransactionTransferToWalletDestination', function() {
      ...
      //var instance = new CoboWaas2.TransactionTransferToWalletDestination();
      //expect(instance).to.be.a(CoboWaas2.TransactionTransferToWalletDestination);
    });
