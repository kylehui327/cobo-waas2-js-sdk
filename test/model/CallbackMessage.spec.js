...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CallbackMessage();
  });
  ...
  describe('CallbackMessage', function() {
    it('should create an instance of CallbackMessage', function() {
      // uncomment below and update the code to test CallbackMessage
      //var instance = new CoboWaas2.CallbackMessage();
      //expect(instance).to.be.a(CoboWaas2.CallbackMessage);
    });
