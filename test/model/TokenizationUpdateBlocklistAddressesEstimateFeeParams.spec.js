...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationUpdateBlocklistAddressesEstimateFeeParams();
  });
  ...
  describe('TokenizationUpdateBlocklistAddressesEstimateFeeParams', function() {
    it('should create an instance of TokenizationUpdateBlocklistAddressesEstimateFeeParams', function() {
      // uncomment below and update the code to test TokenizationUpdateBlocklistAddressesEstimateFeeParams
      //var instance = new CoboWaas2.TokenizationUpdateBlocklistAddressesEstimateFeeParams();
      //expect(instance).to.be.a(CoboWaas2.TokenizationUpdateBlocklistAddressesEstimateFeeParams);
    });
