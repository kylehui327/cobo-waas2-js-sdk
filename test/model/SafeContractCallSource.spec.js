...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.SafeContractCallSource();
  });
  ...
  describe('SafeContractCallSource', function() {
    it('should create an instance of SafeContractCallSource', function() {
      ...
      //var instance = new CoboWaas2.SafeContractCallSource();
      //expect(instance).to.be.a(CoboWaas2.SafeContractCallSource);
    });
