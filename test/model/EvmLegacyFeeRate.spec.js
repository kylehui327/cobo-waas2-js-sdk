...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EvmLegacyFeeRate();
  });
  ...
  describe('EvmLegacyFeeRate', function() {
    it('should create an instance of EvmLegacyFeeRate', function() {
      // uncomment below and update the code to test EvmLegacyFeeRate
      //var instance = new CoboWaas2.EvmLegacyFeeRate();
      //expect(instance).to.be.a(CoboWaas2.EvmLegacyFeeRate);
    });
