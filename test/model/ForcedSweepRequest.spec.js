...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.ForcedSweepRequest();
  });
  ...
  describe('ForcedSweepRequest', function() {
    it('should create an instance of ForcedSweepRequest', function() {
      // uncomment below and update the code to test ForcedSweepRequest
      //var instance = new CoboWaas2.ForcedSweepRequest();
      //expect(instance).to.be.a(CoboWaas2.ForcedSweepRequest);
    });
