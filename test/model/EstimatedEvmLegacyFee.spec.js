...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimatedEvmLegacyFee();
  });
  ...
  describe('EstimatedEvmLegacyFee', function() {
    it('should create an instance of EstimatedEvmLegacyFee', function() {
      // uncomment below and update the code to test EstimatedEvmLegacyFee
      //var instance = new CoboWaas2.EstimatedEvmLegacyFee();
      //expect(instance).to.be.a(CoboWaas2.EstimatedEvmLegacyFee);
    });
