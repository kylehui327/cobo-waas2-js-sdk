...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionEvmLegacyFee();
  });
  ...
  describe('TransactionEvmLegacyFee', function() {
    it('should create an instance of TransactionEvmLegacyFee', function() {
      ...
      //var instance = new CoboWaas2.TransactionEvmLegacyFee();
      //expect(instance).to.be.a(CoboWaas2.TransactionEvmLegacyFee);
    });
