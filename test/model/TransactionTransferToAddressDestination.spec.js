...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionTransferToAddressDestination();
  });
  ...
  describe('TransactionTransferToAddressDestination', function() {
    it('should create an instance of TransactionTransferToAddressDestination', function() {
      ...
      //var instance = new CoboWaas2.TransactionTransferToAddressDestination();
      //expect(instance).to.be.a(CoboWaas2.TransactionTransferToAddressDestination);
    });
