...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.SOLBase();
  });
  ...
  describe('SOLBase', function() {
    it('should create an instance of SOLBase', function() {
      // uncomment below and update the code to test SOLBase
      //var instance = new CoboWaas2.SOLBase();
      //expect(instance).to.be.a(CoboWaas2.SOLBase);
    });
