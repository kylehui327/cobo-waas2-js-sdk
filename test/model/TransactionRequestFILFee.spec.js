...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionRequestFILFee();
  });
  ...
  describe('TransactionRequestFILFee', function() {
    it('should create an instance of TransactionRequestFILFee', function() {
      // uncomment below and update the code to test TransactionRequestFILFee
      //var instance = new CoboWaas2.TransactionRequestFILFee();
      //expect(instance).to.be.a(CoboWaas2.TransactionRequestFILFee);
    });
