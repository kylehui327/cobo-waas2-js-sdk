...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.ExchangeTransferSource();
  });
  ...
  describe('ExchangeTransferSource', function() {
    it('should create an instance of ExchangeTransferSource', function() {
      ...
      //var instance = new CoboWaas2.ExchangeTransferSource();
      //expect(instance).to.be.a(CoboWaas2.ExchangeTransferSource);
    });
