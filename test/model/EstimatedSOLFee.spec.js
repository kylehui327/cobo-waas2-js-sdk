...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimatedSOLFee();
  });
  ...
  describe('EstimatedSOLFee', function() {
    it('should create an instance of EstimatedSOLFee', function() {
      // uncomment below and update the code to test EstimatedSOLFee
      //var instance = new CoboWaas2.EstimatedSOLFee();
      //expect(instance).to.be.a(CoboWaas2.EstimatedSOLFee);
    });
