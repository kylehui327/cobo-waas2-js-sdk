...
(function(root, factory) {
  ...
  describe('CreateSwapActivityRequest', function() {
    ...
    it('should have the property slippage_tolerance (base name: "slippage_tolerance")', function() {
      // uncomment below and update the code to test the property slippage_tolerance
      //var instance = new CoboWaas2.CreateSwapActivityRequest();
      //expect(instance).to.be();
    });
