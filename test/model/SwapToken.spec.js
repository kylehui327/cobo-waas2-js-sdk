...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.SwapToken();
  });
  ...
  describe('SwapToken', function() {
    it('should create an instance of SwapToken', function() {
      // uncomment below and update the code to test SwapToken
      //var instance = new CoboWaas2.SwapToken();
      //expect(instance).to.be.a(CoboWaas2.SwapToken);
    });
