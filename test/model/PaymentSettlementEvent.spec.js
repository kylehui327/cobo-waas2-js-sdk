...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PaymentSettlementEvent();
  });
  ...
  describe('PaymentSettlementEvent', function() {
    it('should create an instance of PaymentSettlementEvent', function() {
      // uncomment below and update the code to test PaymentSettlementEvent
      //var instance = new CoboWaas2.PaymentSettlementEvent();
      //expect(instance).to.be.a(CoboWaas2.PaymentSettlementEvent);
    });
