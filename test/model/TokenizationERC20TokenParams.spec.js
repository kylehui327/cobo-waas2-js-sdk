...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationERC20TokenParams();
  });
  ...
  describe('TokenizationERC20TokenParams', function() {
    it('should create an instance of TokenizationERC20TokenParams', function() {
      // uncomment below and update the code to test TokenizationERC20TokenParams
      //var instance = new CoboWaas2.TokenizationERC20TokenParams();
      //expect(instance).to.be.a(CoboWaas2.TokenizationERC20TokenParams);
    });
