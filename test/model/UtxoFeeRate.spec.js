...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.UtxoFeeRate();
  });
  ...
  describe('UtxoFeeRate', function() {
    it('should create an instance of UtxoFeeRate', function() {
      // uncomment below and update the code to test UtxoFeeRate
      //var instance = new CoboWaas2.UtxoFeeRate();
      //expect(instance).to.be.a(CoboWaas2.UtxoFeeRate);
    });
