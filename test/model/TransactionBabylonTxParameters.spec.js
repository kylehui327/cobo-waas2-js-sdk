...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionBabylonTxParameters();
  });
  ...
  describe('TransactionBabylonTxParameters', function() {
    it('should create an instance of TransactionBabylonTxParameters', function() {
      // uncomment below and update the code to test TransactionBabylonTxParameters
      //var instance = new CoboWaas2.TransactionBabylonTxParameters();
      //expect(instance).to.be.a(CoboWaas2.TransactionBabylonTxParameters);
    });
