...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateMpcWalletParams();
  });
  ...
  describe('CreateMpcWalletParams', function() {
    it('should create an instance of CreateMpcWalletParams', function() {
      // uncomment below and update the code to test CreateMpcWalletParams
      //var instance = new CoboWaas2.CreateMpcWalletParams();
      //expect(instance).to.be.a(CoboWaas2.CreateMpcWalletParams);
    });
