...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionDepositFromWalletSource();
  });
  ...
  describe('TransactionDepositFromWalletSource', function() {
    it('should create an instance of TransactionDepositFromWalletSource', function() {
      ...
      //var instance = new CoboWaas2.TransactionDepositFromWalletSource();
      //expect(instance).to.be.a(CoboWaas2.TransactionDepositFromWalletSource);
    });
