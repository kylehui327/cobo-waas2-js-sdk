...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CustodialWeb3TransferSource();
  });
  ...
  describe('CustodialWeb3TransferSource', function() {
    it('should create an instance of CustodialWeb3TransferSource', function() {
      // uncomment below and update the code to test CustodialWeb3TransferSource
      //var instance = new CoboWaas2.CustodialWeb3TransferSource();
      //expect(instance).to.be.a(CoboWaas2.CustodialWeb3TransferSource);
    });
