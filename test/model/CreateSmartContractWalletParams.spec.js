...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateSmartContractWalletParams();
  });
  ...
  describe('CreateSmartContractWalletParams', function() {
    it('should create an instance of CreateSmartContractWalletParams', function() {
      // uncomment below and update the code to test CreateSmartContractWalletParams
      //var instance = new CoboWaas2.CreateSmartContractWalletParams();
      //expect(instance).to.be.a(CoboWaas2.CreateSmartContractWalletParams);
    });
