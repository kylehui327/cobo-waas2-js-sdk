...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimateTransferFeeParams();
  });
  ...
  describe('EstimateTransferFeeParams', function() {
    it('should create an instance of EstimateTransferFeeParams', function() {
      // uncomment below and update the code to test EstimateTransferFeeParams
      //var instance = new CoboWaas2.EstimateTransferFeeParams();
      //expect(instance).to.be.a(CoboWaas2.EstimateTransferFeeParams);
    });
