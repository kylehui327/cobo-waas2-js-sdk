...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.PayerAccount();
  });
  ...
  describe('PayerAccount', function() {
    it('should create an instance of PayerAccount', function() {
      // uncomment below and update the code to test PayerAccount
      //var instance = new CoboWaas2.PayerAccount();
      //expect(instance).to.be.a(CoboWaas2.PayerAccount);
    });
