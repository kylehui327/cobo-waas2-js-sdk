...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionRequestFee();
  });
  ...
  describe('TransactionRequestFee', function() {
    it('should create an instance of TransactionRequestFee', function() {
      // uncomment below and update the code to test TransactionRequestFee
      //var instance = new CoboWaas2.TransactionRequestFee();
      //expect(instance).to.be.a(CoboWaas2.TransactionRequestFee);
    });
