...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TransactionRequestUtxoFee();
  });
  ...
  describe('TransactionRequestUtxoFee', function() {
    it('should create an instance of TransactionRequestUtxoFee', function() {
      // uncomment below and update the code to test TransactionRequestUtxoFee
      //var instance = new CoboWaas2.TransactionRequestUtxoFee();
      //expect(instance).to.be.a(CoboWaas2.TransactionRequestUtxoFee);
    });
