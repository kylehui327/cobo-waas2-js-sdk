...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EstimatedFee();
  });
  ...
  describe('EstimatedFee', function() {
    it('should create an instance of EstimatedFee', function() {
      // uncomment below and update the code to test EstimatedFee
      //var instance = new CoboWaas2.EstimatedFee();
      //expect(instance).to.be.a(CoboWaas2.EstimatedFee);
    });
