...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationUpdateAllowlistAddressesEstimateFeeParams();
  });
  ...
  describe('TokenizationUpdateAllowlistAddressesEstimateFeeParams', function() {
    it('should create an instance of TokenizationUpdateAllowlistAddressesEstimateFeeParams', function() {
      // uncomment below and update the code to test TokenizationUpdateAllowlistAddressesEstimateFeeParams
      //var instance = new CoboWaas2.TokenizationUpdateAllowlistAddressesEstimateFeeParams();
      //expect(instance).to.be.a(CoboWaas2.TokenizationUpdateAllowlistAddressesEstimateFeeParams);
    });
