...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.EvmEip1559FeeRate();
  });
  ...
  describe('EvmEip1559FeeRate', function() {
    it('should create an instance of EvmEip1559FeeRate', function() {
      // uncomment below and update the code to test EvmEip1559FeeRate
      //var instance = new CoboWaas2.EvmEip1559FeeRate();
      //expect(instance).to.be.a(CoboWaas2.EvmEip1559FeeRate);
    });
