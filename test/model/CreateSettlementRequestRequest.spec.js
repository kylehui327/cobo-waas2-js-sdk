...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.CreateSettlementRequestRequest();
  });
  ...
  describe('CreateSettlementRequestRequest', function() {
    it('should create an instance of CreateSettlementRequestRequest', function() {
      // uncomment below and update the code to test CreateSettlementRequestRequest
      //var instance = new CoboWaas2.CreateSettlementRequestRequest();
      //expect(instance).to.be.a(CoboWaas2.CreateSettlementRequestRequest);
    });
