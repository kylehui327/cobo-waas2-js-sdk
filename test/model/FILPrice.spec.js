...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.FILPrice();
  });
  ...
  describe('FILPrice', function() {
    it('should create an instance of FILPrice', function() {
      // uncomment below and update the code to test FILPrice
      //var instance = new CoboWaas2.FILPrice();
      //expect(instance).to.be.a(CoboWaas2.FILPrice);
    });
