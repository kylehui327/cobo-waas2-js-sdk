...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CoboWaas2.TokenizationIssuedTokenRequest();
  });
  ...
  describe('TokenizationIssuedTokenRequest', function() {
    it('should create an instance of TokenizationIssuedTokenRequest', function() {
      // uncomment below and update the code to test TokenizationIssuedTokenRequest
      //var instance = new CoboWaas2.TokenizationIssuedTokenRequest();
      //expect(instance).to.be.a(CoboWaas2.TokenizationIssuedTokenRequest);
    });
