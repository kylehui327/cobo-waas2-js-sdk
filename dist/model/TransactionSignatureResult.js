...
var TransactionSignatureResult = /*#__PURE__*/function () {
   ...
   */
  function TransactionSignatureResult(signature) {
    _classCallCheck(this, TransactionSignatureResult);
   ...
   */
  return _createClass(TransactionSignatureResult, null, [{
    key: "initialize",
    value: function initialize(obj, signature) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('result_type')) {
          obj['result_type'] = _TransactionResultType["default"].constructFromObject(data['result_type']);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TransactionSignatureResult.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = TransactionSignatureResult;