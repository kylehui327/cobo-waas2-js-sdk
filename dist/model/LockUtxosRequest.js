...
var _LockUtxosRequestUtxosInner = _interopRequireDefault(require("./LockUtxosRequestUtxosInner"));
 ...
 */
var LockUtxosRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function LockUtxosRequest(utxos) {
    _classCallCheck(this, LockUtxosRequest);
   ...
   */
  return _createClass(LockUtxosRequest, null, [{
    key: "initialize",
    value: function initialize(obj, utxos) {
      obj['utxos'] = utxos;
    }
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('utxos')) {
          obj['utxos'] = _ApiClient["default"].convertToType(data['utxos'], [_LockUtxosRequestUtxosInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(LockUtxosRequest.RequiredProperties),
        _step;
      try {
      ...
      if (data['utxos']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _LockUtxosRequestUtxosInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = LockUtxosRequest;