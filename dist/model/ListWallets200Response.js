...
var ListWallets200Response = /*#__PURE__*/function () {
   ...
   */
  function ListWallets200Response() {
   ...
   */
  return _createClass(ListWallets200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_WalletInfo["default"]]);
        }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _WalletInfo["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
