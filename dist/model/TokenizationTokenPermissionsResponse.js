...
var _TokenizationTokenPermission = _interopRequireDefault(require("./TokenizationTokenPermission"));
 ...
 */
var TokenizationTokenPermissionsResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function TokenizationTokenPermissionsResponse(permissions, total_count) {
    _classCallCheck(this, TokenizationTokenPermissionsResponse);
   ...
   */
  return _createClass(TokenizationTokenPermissionsResponse, null, [{
    key: "initialize",
    value: function initialize(obj, permissions, total_count) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('permissions')) {
          obj['permissions'] = _ApiClient["default"].convertToType(data['permissions'], [_TokenizationTokenPermission["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TokenizationTokenPermissionsResponse.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = TokenizationTokenPermissionsResponse;