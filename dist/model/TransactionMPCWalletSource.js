...
var TransactionMPCWalletSource = /*#__PURE__*/function () {
   ...
   */
  function TransactionMPCWalletSource(source_type, wallet_id) {
    _classCallCheck(this, TransactionMPCWalletSource);
   ...
   */
  return _createClass(TransactionMPCWalletSource, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TransactionMPCWalletSource.RequiredProperties),
        _step;
      try {
