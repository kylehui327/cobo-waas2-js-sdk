 ...
 */
var TransactionTokeApproval = /*#__PURE__*/function () {
  /**
  ...
  function TransactionTokeApproval(token_id, chain_id) {
    _classCallCheck(this, TransactionTokeApproval);
   ...
   */
  return _createClass(TransactionTokeApproval, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('spender')) {
          obj['spender'] = _ApiClient["default"].convertToType(data['spender'], 'String');
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TransactionTokeApproval.RequiredProperties),
        _step;
      try {
