 ...
 */
var EstimateWithdrawFee = /*#__PURE__*/function () {
  /**
   ...
   */
  function EstimateWithdrawFee(activity_type, staking_id, fee) {
    _classCallCheck(this, EstimateWithdrawFee);
   ...
   */
  return _createClass(EstimateWithdrawFee, null, [{
    key: "initialize",
    value: function initialize(obj, activity_type, staking_id, fee) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(EstimateWithdrawFee.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = EstimateWithdrawFee;