 ...
 */
var UpdateKeyShareHolderGroupByIdRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function UpdateKeyShareHolderGroupByIdRequest(update_key_share_holder_group_action) {
    _classCallCheck(this, UpdateKeyShareHolderGroupByIdRequest);
   ...
   */
  return _createClass(UpdateKeyShareHolderGroupByIdRequest, null, [{
    key: "initialize",
    value: function initialize(obj, update_key_share_holder_group_action) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UpdateKeyShareHolderGroupByIdRequest.RequiredProperties),
        _step;
      try {
