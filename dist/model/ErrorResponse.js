...
var ErrorResponse = /*#__PURE__*/function () {
   ...
   */
  function ErrorResponse(error_code, error_message, error_id) {
  ...
  return _createClass(ErrorResponse, null, [{
    key: "initialize",
    value: function initialize(obj, error_code, error_message, error_id) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error_code')) {
          obj['error_code'] = _ApiClient["default"].convertToType(data['error_code'], 'Number');
        }
        if (data.hasOwnProperty('error_message')) {
          obj['error_message'] = _ApiClient["default"].convertToType(data['error_message'], 'String');
        }
        if (data.hasOwnProperty('error_id')) {
          obj['error_id'] = _ApiClient["default"].convertToType(data['error_id'], 'String');
        }
      }
      return obj;
    }
