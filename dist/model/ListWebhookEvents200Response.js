 ...
 */
var ListWebhookEvents200Response = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListWebhookEvents200Response</code>.
   * @alias module:model/ListWebhookEvents200Response
   */
  function ListWebhookEvents200Response() {
    _classCallCheck(this, ListWebhookEvents200Response);
   ...
   */
  return _createClass(ListWebhookEvents200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_WebhookEvent["default"]]);
        }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _WebhookEvent["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListWebhookEvents200Response;