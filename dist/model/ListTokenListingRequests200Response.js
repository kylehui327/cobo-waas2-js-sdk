 ...
 */
var ListTokenListingRequests200Response = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListTokenListingRequests200Response</code>.
   * @alias module:model/ListTokenListingRequests200Response
   */
  function ListTokenListingRequests200Response() {
    _classCallCheck(this, ListTokenListingRequests200Response);
   ...
   */
  return _createClass(ListTokenListingRequests200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_TokenListing["default"]]);
        }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _TokenListing["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListTokenListingRequests200Response;