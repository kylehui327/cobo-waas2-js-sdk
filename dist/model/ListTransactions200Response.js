 ...
 */
var ListTransactions200Response = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListTransactions200Response</code>.
   * @alias module:model/ListTransactions200Response
   */
  function ListTransactions200Response() {
    _classCallCheck(this, ListTransactions200Response);
   ...
   */
  return _createClass(ListTransactions200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_Transaction["default"]]);
        }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Transaction["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListTransactions200Response;