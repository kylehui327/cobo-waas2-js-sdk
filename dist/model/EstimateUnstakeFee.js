 ...
 */
var EstimateUnstakeFee = /*#__PURE__*/function () {
  /**
   ...
   */
  function EstimateUnstakeFee(activity_type, staking_id) {
    _classCallCheck(this, EstimateUnstakeFee);
   ...
   */
  return _createClass(EstimateUnstakeFee, null, [{
    key: "initialize",
    value: function initialize(obj, activity_type, staking_id) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(EstimateUnstakeFee.RequiredProperties),
        _step;
      try {
