 ...
 */
var ListStakingPools200Response = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListStakingPools200Response</code>.
   * @alias module:model/ListStakingPools200Response
   */
  function ListStakingPools200Response() {
    _classCallCheck(this, ListStakingPools200Response);
   ...
   */
  return _createClass(ListStakingPools200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_PoolSummary["default"]]);
        }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _PoolSummary["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListStakingPools200Response;