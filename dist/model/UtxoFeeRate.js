 ...
 */
var UtxoFeeRate = /*#__PURE__*/function () {
  /**
  ...
  function UtxoFeeRate(fee_type, token_id, recommended) {
    _classCallCheck(this, UtxoFeeRate);
   ...
   */
  return _createClass(UtxoFeeRate, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('slow')) {
          obj['slow'] = _ApiClient["default"].convertToType(data['slow'], _UtxoFeeBasePrice["default"]);
        }
        if (data.hasOwnProperty('recommended')) {
          obj['recommended'] = _ApiClient["default"].convertToType(data['recommended'], _UtxoFeeBasePrice["default"]);
        }
        if (data.hasOwnProperty('fast')) {
          obj['fast'] = _ApiClient["default"].convertToType(data['fast'], _UtxoFeeBasePrice["default"]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UtxoFeeRate.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = UtxoFeeRate;