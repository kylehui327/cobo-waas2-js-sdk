 ...
 */
var AmountDetailsInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function AmountDetailsInner(status, amount) {
    _classCallCheck(this, AmountDetailsInner);
   ...
   */
  return _createClass(AmountDetailsInner, null, [{
    key: "initialize",
    value: function initialize(obj, status, amount) {
      obj['status'] = status;
      obj['amount'] = amount;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AmountDetailsInner.RequiredProperties),
        _step;
      try {
