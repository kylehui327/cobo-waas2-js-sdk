 ...
 */
var MpcMessageSignSource = /*#__PURE__*/function () {
  /**
   ...
   */
  function MpcMessageSignSource(source_type, wallet_id, address) {
    _classCallCheck(this, MpcMessageSignSource);
   ...
   */
  return _createClass(MpcMessageSignSource, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(MpcMessageSignSource.RequiredProperties),
        _step;
      try {
