 ...
 */
var ListMpcVaults200Response = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListMpcVaults200Response</code>.
   * @alias module:model/ListMpcVaults200Response
   */
  function ListMpcVaults200Response() {
    _classCallCheck(this, ListMpcVaults200Response);
   ...
   */
  return _createClass(ListMpcVaults200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_MPCVault["default"]]);
        }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _MPCVault["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = exports["default"] = ListMpcVaults200Response;