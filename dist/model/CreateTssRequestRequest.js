 ...
 */
var CreateTssRequestRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateTssRequestRequest(type, target_key_share_holder_group_id) {
    _classCallCheck(this, CreateTssRequestRequest);
   ...
   */
  return _createClass(CreateTssRequestRequest, null, [{
    key: "initialize",
    value: function initialize(obj, type, target_key_share_holder_group_id) {
      obj['type'] = type;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateTssRequestRequest.RequiredProperties),
        _step;
      try {
