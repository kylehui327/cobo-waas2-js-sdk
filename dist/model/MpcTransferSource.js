...
var MpcTransferSource = /*#__PURE__*/function () {
   ...
   */
  function MpcTransferSource(source_type, wallet_id) {
    _classCallCheck(this, MpcTransferSource);
   ...
   */
  return _createClass(MpcTransferSource, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(MpcTransferSource.RequiredProperties),
        _step;
      try {
