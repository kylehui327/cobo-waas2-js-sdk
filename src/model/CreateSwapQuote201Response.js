 ...
 */
class CreateSwapQuote201Response {
    /**
     ...
     */
    constructor(pay_amount, receive_amount, fee_amount, quote_expired_timestamp, quote_id) { 
     ...
     */
    static initialize(obj, pay_amount, receive_amount, fee_amount, quote_expired_timestamp, quote_id) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            SwapQuote.constructFromObject(data, obj);
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateSwapQuote201Response.RequiredProperties) {
...
export default CreateSwapQuote201Response;
