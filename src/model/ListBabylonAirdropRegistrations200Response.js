...
import BabylonAirdropRegistration from './BabylonAirdropRegistration';
 ...
 */
class ListBabylonAirdropRegistrations200Response {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [BabylonAirdropRegistration]);
            }
    ...
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                BabylonAirdropRegistration.validateJSON(item);
            };
        }
...
export default ListBabylonAirdropRegistrations200Response;
