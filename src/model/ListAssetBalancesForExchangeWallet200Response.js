    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [SubWalletAssetBalance]);
            }
    ...
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                SubWalletAssetBalance.validateJSON(item);
            };
        }
...
export default ListAssetBalancesForExchangeWallet200Response;
