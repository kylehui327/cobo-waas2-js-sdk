...
class TransactionDetails {
     ...
     */
    constructor(transaction_id, wallet_id, status, source, destination, initiator_type, created_time, updated_time) { 
        Transaction.initialize(this, transaction_id, wallet_id, status, source, destination, initiator_type, created_time, updated_time);
        TransactionDetails.initialize(this, transaction_id, wallet_id, status, source, destination, initiator_type, created_time, updated_time);
    }
     ...
     */
    static initialize(obj, transaction_id, wallet_id, status, source, destination, initiator_type, created_time, updated_time) { 
...
TransactionDetails.RequiredProperties = ["transaction_id", "wallet_id", "status", "source", "destination", "initiator_type", "created_time", "updated_time"];
