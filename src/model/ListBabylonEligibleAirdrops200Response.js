...
import BabylonEligibleAirdrop from './BabylonEligibleAirdrop';
 ...
 */
class ListBabylonEligibleAirdrops200Response {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [BabylonEligibleAirdrop]);
            }
    ...
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                BabylonEligibleAirdrop.validateJSON(item);
            };
        }
...
export default ListBabylonEligibleAirdrops200Response;
