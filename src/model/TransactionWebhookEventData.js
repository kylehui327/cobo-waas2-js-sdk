...
class TransactionWebhookEventData {
     ...
     */
    constructor(data_type, transaction_id, wallet_id, status, source, destination, initiator_type, created_time, updated_time) { 
        WebhookEventDataType.initialize(this, data_type);Transaction.initialize(this, transaction_id, wallet_id, status, source, destination, initiator_type, created_time, updated_time);
        TransactionWebhookEventData.initialize(this, data_type, transaction_id, wallet_id, status, source, destination, initiator_type, created_time, updated_time);
    }
     ...
     */
    static initialize(obj, data_type, transaction_id, wallet_id, status, source, destination, initiator_type, created_time, updated_time) { 
...
TransactionWebhookEventData.RequiredProperties = ["data_type", "transaction_id", "wallet_id", "status", "source", "destination", "initiator_type", "created_time", "updated_time"];
 ...
 */
TransactionWebhookEventData.prototype['created_time'] = undefined;

/**
 * The time when the transaction was updated, in Unix timestamp format, measured in milliseconds.
 * @member {Number} updated_time
 */
TransactionWebhookEventData.prototype['updated_time'] = undefined;
