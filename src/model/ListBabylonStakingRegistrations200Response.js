...
import BabylonStakingRegistration from './BabylonStakingRegistration';
 ...
 */
class ListBabylonStakingRegistrations200Response {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [BabylonStakingRegistration]);
            }
    ...
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                BabylonStakingRegistration.validateJSON(item);
            };
        }
...
export default ListBabylonStakingRegistrations200Response;
