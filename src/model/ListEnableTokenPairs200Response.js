    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [SwapTokenPair]);
            }
    ...
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                SwapTokenPair.validateJSON(item);
            };
        }
...
export default ListEnableTokenPairs200Response;
