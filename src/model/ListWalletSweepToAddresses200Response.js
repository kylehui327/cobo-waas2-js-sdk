    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [SweepToAddress]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                SweepToAddress.validateJSON(item);
            };
        }
...
export default ListWalletSweepToAddresses200Response;
