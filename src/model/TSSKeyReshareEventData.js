...
import TSSKeyReshareRequest from './TSSKeyReshareRequest';
...
class TSSKeyReshareEventData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('request_detail')) {
                obj['request_detail'] = TSSKeyReshareRequest.constructFromObject(data['request_detail']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of TSSKeyReshareEventData.RequiredProperties) {
        ...
        if (data['request_detail']) { // data not null
          if (!!TSSKeyReshareRequest.validateJSON) {
            TSSKeyReshareRequest.validateJSON(data['request_detail']);
          }
        }
...
export default TSSKeyReshareEventData;
